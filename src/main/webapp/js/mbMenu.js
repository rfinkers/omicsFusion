                    ...
                    if ($.metadata) {
                        ...
                        $(thisMenu.menuvoice).each(function() {
                            ...
                            if ($(this).metadata().disabled)
                                $(this).attr("isDisable", $(this).metadata().disabled);
                        });
                    }
                ...
                if ($.metadata) {
                    ...
                    $(cMenuEls).each(function() {
                        if ($(this).metadata().cMenu)
                            $(this).attr("cMenu", $(this).metadata().cMenu);
                    });
                }
    ...
    $.fn.extend({
            ...
            if ($.metadata) {
                ...
                $(this.voices).each(function() {
                    ...
                    if ($(this).metadata().action)
                        $(this).attr("action", $(this).metadata().action);
                });
            }
        ...
        removeMbMenu: function(op, fade) {
            ...
            if (op.rootMenu) {
                ...
                if (fade)
                    $(op.rootMenu).fadeOut(op.options.fadeOutTime, function() {
                        $(this).remove();
                    });
                else
                    $(op.rootMenu).remove();
