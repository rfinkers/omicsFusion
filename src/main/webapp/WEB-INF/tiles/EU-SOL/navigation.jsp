...
<div id="menu_2" class="mbmenu">
    ...
    <logic:present name="userConfig">
        ...
        <html:link page="/experiment/ExperimentOverview.jsp" styleClass="{img: 'ico_view.gif'}"><bean:message key="menu.population.overview"/></html:link>
    </logic:present>
    <html:link page="/experiment/DetailledOverview.jsp" styleClass="{img: 'ico_view.gif'}"><bean:message key="menu.database.summary"/></html:link>
</div>
...
<div id="menu_4" class="mbmenu">
    ...
    <a class="{img: 'ico_view.gif', disabled:true}"><bean:message key="menu.markers.markers"/></a>
    <a class="{img: 'ico_view.gif', disabled:true}"><bean:message key="menu.markers.export"/></a>
    <logic:present name="userConfig">
...
<div id="menu_5" class="mbmenu">
    ...
    <logic:present name="userConfig">
        <html:link page="/ggtQtl/GraphicalGenotypes.do" styleClass="{img: 'ico_view.gif'}"><bean:message key="menu.maps.maps"/></html:link>
        <a class="{img: 'ico_view.gif', disabled:true}"><bean:message key="menu.maps.compare"/></a>
        <a class="{img: 'ico_view.gif', disabled:true}"><bean:message key="menu.maps.export"/></a>
    </logic:present>
</div>
...
<div id="menu_8" class="mbmenu">
    ...
    <html:link page="/links.jsp" styleClass="{menu: 'sub_menu_6', img: 'icon_14.png'}"><bean:message key="menu.links.partners"/></html:link>
</div>
